"""
Base settings for codea_auth_server project.
...
SIMPLE_JWT = {
    ...
    'ALGORITHM': 'HS256',
    'SIGNING_KEY': None,  # Will be set in dev/prod files
    'VERIFYING_KEY': None,
    'AUDIENCE': None,
    'ISSUER': None,
    'JWK_URL': None,
...
# Configuration is defined in dev.py and prod.py with environment-specific values
